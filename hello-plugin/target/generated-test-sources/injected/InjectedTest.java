...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","C:\\JenkinsgitWorkspace\\hello-plugin");
    parameters.put("artifactId","hello");
    parameters.put("packaging","hpi");
    parameters.put("outputDirectory","C:\\JenkinsgitWorkspace\\hello-plugin\\target\\classes");
    parameters.put("testOutputDirectory","C:\\JenkinsgitWorkspace\\hello-plugin\\target\\test-classes");
